...
# -*- coding: utf-8 -*-
#
# diffpy.similarity documentation build configuration file, created by
...
modindex_common_prefix = ["diffpy.similarity"]
...
basename = "diffpy.similarity".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "diffpy.similarity.tex",
        "diffpy.similarity Documentation",
        ab_authors,
        "manual",
    ),
]
